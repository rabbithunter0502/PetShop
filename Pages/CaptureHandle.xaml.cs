...
namespace PetShop.Pages
{
    ...
    public sealed partial class CaptureHandle : Page
    {
        private const string API_URI = "https://2-dot-backup-server-003.appspot.com/get-upload-token";
        ...
        private void ChooseFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            string uploadUrl =  httpClient.GetAsync(API_URI).Result.Content.ReadAsStringAsync().Result;

            CaptureHandle cap = new CaptureHandle();
            cap.HttpUploadFile(uploadUrl, "myFile", "image/jpg");
        }
    }
}
